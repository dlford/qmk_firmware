...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT(KC_TRNS, M_TEST, KC_MAIL, KC_CALC, KC_MYCM, RESET, KC_BRID, KC_BRIU, KC_WFAV, KC_WREF, KC_SLEP, RGUI_T(KC_DEL), LALT_T(KC_EXLM), KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_TRNS, KC_WHOM, KC_WSCH, KC_WBAK, KC_WFWD, BL_ON, RALT_T(BL_STEP), LCTL_T(KC_CAPS), KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2, KC_BTN3, BL_TOGG, RCTL_T(BL_INC), LSFT_T(KC_LPRN), KC_RPRN, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_TRNS, KC_TRNS, KC_TRNS, KC_ACL0, KC_ACL1, KC_ACL2, BL_OFF, RSFT_T(BL_DEC), KC_TRNS, KC_UNDS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
